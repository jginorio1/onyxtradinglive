...
export const CATEGORIES = [
  ...
  { id: 'botlab',  icon: '🛒', color: 'var(--gold)',   name: { es: 'Onyx Bot Lab',           en: 'Onyx Bot Lab' } },
];
...
export const ARTICLES: Article[] = [
  ...
  {
    slug: 'crea-tu-robot',
    cat: 'botlab', icon: '🛠️', updated: true,
    title: { es: 'Crea tu robot sin código', en: 'Build your robot without code' },
    summary: { es: 'Arma tu robot paso a paso en el constructor y descárgalo listo para MT4, MT5 o cTrader.', en: 'Assemble your robot step by step in the builder and download it ready for MT4, MT5 or cTrader.' },
    cta: { href: '/bot-builder', label: { es: 'Ir a Crea tu bot', en: 'Go to Build a bot' } },
    seo: {
      title: { es: 'Crea tu robot de trading sin código · Guía Onyx Bot Lab', en: 'Build a trading robot without code · Onyx Bot Lab guide' },
      desc: { es: 'Cómo crear tu propio robot en el constructor de Onyx: instrumento, entradas, stop loss, gestión de riesgo y reglas de tu prop firm. Sin programar.', en: 'How to build your own robot in the Onyx builder: instrument, entries, stop loss, risk management and your prop-firm rules. No coding.' },
      keywords: { es: ['crear robot trading', 'constructor de bots', 'ea sin código', 'onyx bot lab'], en: ['build trading robot', 'bot builder', 'no-code ea', 'onyx bot lab'] },
    },
    body: {
      es: [
        { p: '"Crea tu bot" es el constructor visual de Onyx Bot Lab: armas tu propio robot eligiendo opciones en tarjetas, sin escribir una línea de código. Es para quien quiere una estrategia hecha a su medida. Al terminar, Onyx genera el archivo listo para tu plataforma y una guía en PDF con capturas.' },
        { h: 'Los 6 pasos' },
        { steps: ['Instrumento: elige qué opera el robot (par, metal, índice, cripto o petróleo) con el buscador.', 'Entradas: define cómo entra al mercado (tendencia, ruptura, rango…) y el timeframe.', 'Salidas: pon tu stop loss y take profit.', 'Riesgo: cuánto arriesga por operación y los límites.', 'Reglas de fondeo: pérdida diaria, drawdown total y objetivo de tu prop firm (opcional).', 'Resumen: revisa todo en "Resumen de tu robot" y descárgalo.'] },
        { p: 'El "Resumen de tu robot" es un espejo de las 6 secciones: si algo falta, te lo marca en ámbar y puedes saltar directo a corregirlo.' },
        { h: 'Al terminar' },
        { p: 'Descargas el archivo correcto para tu plataforma (.mq5 para MT5, .mq4 para MT4, .cs para cTrader) y lo instalas con la guía paso a paso. Tus creaciones quedan guardadas en "Mis creaciones", donde puedes buscarlas, ordenarlas, duplicarlas y ver su fecha.' },
        { tip: 'Prueba siempre primero en cuenta demo. Cuando tu robot acumule historial real, podrás publicarlo en el marketplace y cobrar a otros por usarlo.' },
        { warn: 'Ningún robot garantiza ganancias. El constructor te da control y protección, pero el trading siempre conlleva riesgo: usa solo capital que puedas permitirte arriesgar.' },
      ],
      en: [
        { p: '"Build a bot" is the visual builder in Onyx Bot Lab: you assemble your own robot by picking options on cards, without writing a line of code. It is for those who want a strategy tailored to them. When you finish, Onyx generates the file ready for your platform plus a PDF guide with screenshots.' },
        { h: 'The 6 steps' },
        { steps: ['Instrument: pick what the robot trades (pair, metal, index, crypto or oil) with the search.', 'Entries: define how it enters (trend, breakout, range…) and the timeframe.', 'Exits: set your stop loss and take profit.', 'Risk: how much it risks per trade and the limits.', 'Firm rules: daily loss, total drawdown and your prop-firm target (optional).', 'Summary: review everything in "Your robot summary" and download it.'] },
        { p: '"Your robot summary" mirrors the 6 sections: if something is missing it flags it in amber and you can jump straight to fix it.' },
        { h: 'When you finish' },
        { p: 'You download the right file for your platform (.mq5 for MT5, .mq4 for MT4, .cs for cTrader) and install it with the step-by-step guide. Your creations are saved in "My creations", where you can search, sort, duplicate and see their date.' },
        { tip: 'Always test on a demo account first. Once your robot has a real track record, you can list it on the marketplace and charge others to use it.' },
        { warn: 'No robot guarantees profit. The builder gives you control and protection, but trading always carries risk: only use capital you can afford to risk.' },
      ],
    },
  },
  {
    slug: 'comprar-robot',
    cat: 'botlab', icon: '🛒', updated: true,
    title: { es: 'Comprar un robot en el marketplace', en: 'Buy a robot in the marketplace' },
    summary: { es: 'Cómo elegir por Onyx Score, pagar en USDT y descargar el robot para tu plataforma.', en: 'How to choose by Onyx Score, pay in USDT and download the robot for your platform.' },
    cta: { href: '/bot-lab', label: { es: 'Ver el marketplace', en: 'See the marketplace' } },
    seo: {
      title: { es: 'Comprar un robot de trading en Onyx Bot Lab · Guía', en: 'Buy a trading robot in Onyx Bot Lab · Guide' },
      desc: { es: 'Guía para comprar robots ya hechos de traders verificados: cómo leer el Onyx Score, pagar en USDT y descargar el archivo protegido para MT4, MT5 o cTrader.', en: 'Guide to buying ready-made robots from verified traders: how to read the Onyx Score, pay in USDT and download the protected file for MT4, MT5 or cTrader.' },
      keywords: { es: ['comprar robot trading', 'marketplace de robots', 'ea usdt', 'onyx bot lab'], en: ['buy trading robot', 'robot marketplace', 'ea usdt', 'onyx bot lab'] },
    },
    body: {
      es: [
        { p: 'El marketplace de Onyx Bot Lab reúne robots ya hechos por traders verificados. Es para quien quiere resultados rápidos sin construir nada: eliges un robot, lo compras y lo instalas.' },
        { h: 'Cómo elegir' },
        { p: 'Cada robot muestra su ficha: Onyx Score, rendimiento de 90 días y drawdown máximo, más sellos como "Sin martingala", "Sin alta frecuencia" y "Con Stop Loss". Solo se publica un robot que cumple reglas medidas con sus operaciones REALES, y los vendedores verificados llevan un sello.' },
        { steps: ['Entra al marketplace y compara Onyx Score, rendimiento y riesgo.', 'Abre el robot que te convenza.', 'Paga en USDT (TRON o Ethereum).', 'Recibes la licencia al instante y descargas el archivo para tu plataforma.'] },
        { h: 'Instalarlo' },
        { p: 'Descargas el archivo protegido para MT4, MT5 o cTrader y lo instalas con la guía paso a paso (o dejas que te lo instalemos). Cada robot lleva su clave de activación: nadie puede revenderlo.' },
        { note: 'Recomendamos correrlo primero en cuenta demo. Solo pásalo a real cuando te convenzan su Onyx Score, rendimiento y drawdown.', title: 'Pruébalo antes' },
        { warn: 'Ningún robot garantiza ganancias y los resultados pasados no aseguran resultados futuros. Invierte solo lo que puedas permitirte arriesgar.' },
      ],
      en: [
        { p: 'The Onyx Bot Lab marketplace gathers ready-made robots from verified traders. It is for those who want fast results without building anything: you pick a robot, buy it and install it.' },
        { h: 'How to choose' },
        { p: 'Each robot shows its card: Onyx Score, 90-day performance and max drawdown, plus seals like "No martingale", "No high frequency" and "Stop Loss". A robot only gets published if it passes rules measured against its REAL trades, and verified sellers carry a badge.' },
        { steps: ['Open the marketplace and compare Onyx Score, performance and risk.', 'Open the robot you like.', 'Pay in USDT (TRON or Ethereum).', 'You get the license instantly and download the file for your platform.'] },
        { h: 'Installing it' },
        { p: 'You download the protected file for MT4, MT5 or cTrader and install it with the step-by-step guide (or we install it for you). Each robot carries its activation key: nobody can resell it.' },
        { note: 'We recommend running it on a demo account first. Only go live when its Onyx Score, performance and drawdown convince you.', title: 'Test it first' },
        { warn: 'No robot guarantees profit and past results do not ensure future results. Only invest what you can afford to risk.' },
      ],
    },
  },
  {
    slug: 'vender-robot',
    cat: 'botlab', icon: '💰', updated: true,
    title: { es: 'Vender tu robot y cobrar', en: 'Sell your robot and get paid' },
    summary: { es: 'Cuándo califica tu robot, cómo se publica solo y cómo cobras tus ventas en USDT.', en: 'When your robot qualifies, how it auto-publishes and how you get paid in USDT.' },
  ...
  },
  {
    slug: 'pagar-usdt',
    cat: 'botlab', icon: '₮', updated: true,
    title: { es: 'Pagar con USDT', en: 'Paying with USDT' },
    summary: { es: 'Qué es USDT, las redes TRON y Ethereum, cómo se confirma el pago y por qué es seguro.', en: 'What USDT is, the TRON and Ethereum networks, how the payment confirms and why it is safe.' },
    cta: { href: '/bot-lab', label: { es: 'Ver el marketplace', en: 'See the marketplace' } },
    seo: {
      title: { es: 'Pagar con USDT en Onyx Bot Lab · Guía', en: 'Paying with USDT in Onyx Bot Lab · Guide' },
      desc: { es: 'Cómo pagar tus robots en USDT: redes TRON y Ethereum, confirmación on-chain, sin bancos ni tarjetas y sin contracargos.', en: 'How to pay for your robots in USDT: TRON and Ethereum networks, on-chain confirmation, no banks or cards and no chargebacks.' },
      keywords: { es: ['pagar usdt', 'usdt tron ethereum', 'pago cripto robots', 'onyx bot lab'], en: ['pay usdt', 'usdt tron ethereum', 'crypto payment robots', 'onyx bot lab'] },
    },
    body: {
      es: [
        { p: 'En Onyx Bot Lab pagas y cobras en USDT, una cripto estable ligada al dólar (1 USDT ≈ $1). Sin bancos, sin tarjetas y sin contracargos: el cobro es global e instantáneo.' },
        { h: 'Las redes' },
        { p: 'Aceptamos USDT en dos redes: TRON (TRC20) y Ethereum (ERC20). TRON suele tener comisiones más baratas; Ethereum es la más extendida. Eliges la red al pagar y te mostramos la dirección de wallet correcta para esa red.' },
        { warn: 'Envía siempre USDT por la MISMA red que elegiste. Si mandas por otra red, el pago se puede perder. Copia la dirección tal cual la mostramos.' },
        { h: 'Cómo se confirma' },
      ...
      en: [
        ...
        { h: 'The networks' },
        { p: 'We accept USDT on two networks: TRON (TRC20) and Ethereum (ERC20). TRON usually has cheaper fees; Ethereum is the most widespread. You pick the network at checkout and we show you the right wallet address for that network.' },
        { warn: 'Always send USDT on the SAME network you chose. Sending on another network can lose the payment. Copy the address exactly as we show it.' },
        { h: 'How it confirms' },
        { steps: ['Choose "USDT" at checkout and the network (TRON or Ethereum).', 'We show the wallet address; you send the amount from your own wallet.', 'The system confirms the payment on-chain (usually within minutes).', 'Your robot activates as soon as it confirms and you download the file.'] },
        { h: 'Is it safe?' },
        { p: 'Yes. We never ask for your wallet keys: you send the payment yourself from your own wallet. Every transaction is recorded on-chain with its hash, which serves as proof of payment.' },
        { note: 'Creators also cash out their sales in USDT, with a $10 minimum to withdraw.', title: 'For sellers' },
      ],
    },
  },
  ...
  },
  {
    ...
    body: {
      es: [
        ...
        { warn: 'Un EA solo funciona con MetaTrader abierto y con conexión. Si apagas el ordenador, deja de registrar y deja de proteger. Si operas en serio, plantéate un [[VPS]] para dejarlo corriendo 24/7.' },
      ],
      en: [
        ...
        { warn: 'An EA only works with MetaTrader open and connected. If you shut down your computer, it stops recording and stops protecting. If you trade seriously, consider a [[VPS]] to keep it running 24/7.' },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    body: {
      es: [
        ...
        { h: 'Empezar gratis' },
        { p: 'Puedes crear tu cuenta gratis y probar Onyx antes de suscribirte. Cuando quieras más cuentas o más funciones, subes de plan. [[TRIAL]]' },
        { h: 'Cambiar de plan' },
      ...
      en: [
        ...
        { h: 'Start free' },
        { p: 'You can create your account for free and try Onyx before subscribing. When you want more accounts or features, you upgrade. [[TRIAL]]' },
        { h: 'Changing plans' },

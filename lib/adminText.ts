...
const ES = {
  ...
  pl_mtAccounts: 'Cuentas MT', pl_historyDays: 'Días de historial', pl_unlimited: '(0 = ilimitado)', pl_copySlaves: 'Copy trading: nº de esclavas', pl_copyMasters: 'Copy trading: nº de masters',
  ...
  am_commMonths: 'Meses de comisión / suscriptor (0 = ∞)',
...
const EN: Dict = {
  ...
  pl_nameEn: 'Name', pl_descEn: 'Short description', pl_badgeEn: 'Badge (e.g. Most popular)', pl_featuresEn: 'Features (one per line)',
  pl_mtAccounts: 'MT accounts', pl_historyDays: 'History days', pl_unlimited: '(0 = unlimited)', pl_copySlaves: 'Copy trading: nº of slaves', pl_copyMasters: 'Copy trading: nº of masters',
  ...
  am_commMonths: 'Commission months / subscriber (0 = ∞)',

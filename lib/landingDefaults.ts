...
export const DEFAULT_ECO = {
  ...
  cards: [
    ...
    { i: '🏆', t_es: 'Onyx Copy', t_en: 'Onyx Copy', d_es: 'Marketplace de traders calificados por Onyx AI (Silver, Gold, Diamond). Copia a los mejores con tus controles de riesgo, o ponte a calificar y gana por tu operativa.', d_en: 'Marketplace of traders graded by Onyx AI (Silver, Gold, Diamond). Copy the best with your own risk controls, or get graded and earn from your trading.' },
...
export const DEFAULT_FAQ: Record<string, [string, string, string, string][]> = {
  landing: [
    ...
    ['¿Qué es Onyx Bot Lab?', 'Es nuestro marketplace de robots. Si no quieres armar el tuyo, en Bot Lab compras robots ya hechos por traders verificados (pago único en USDT) y los instalas en MT4, MT5 o cTrader. Y si creas robots con "Crea tu bot", cuando tienen historial real los publicas ahí y cobras a otros. Lo abres desde el tab Bot Lab · Marketplace.', 'What is Onyx Bot Lab?', 'It\'s our robot marketplace. If you\'d rather not build your own, in Bot Lab you buy ready-made robots from verified traders (one-time payment in USDT) and install them on MT4, MT5 or cTrader. And if you create robots with "Build a bot", once they have a real track record you list them there and charge others. Open it from the Bot Lab · Marketplace tab.'],

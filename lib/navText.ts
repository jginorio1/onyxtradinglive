...
export const NAV_T: Record<Lang, Record<string, string>> = {
  es: {
    dashboard: 'Panel', accounts: 'Cuentas MT', manager: 'Guardian', copy: 'Copy', bots: 'Bots', support: 'Soporte', admin: 'Admin',
    home: 'Inicio', plans: 'Planes', ambassadors: 'Embajadores', guide: 'Guía',
    login: 'Entrar', signup: 'Empezar gratis',
    myAccount: 'Mi cuenta', myPlan: 'Mi plan', referrals: 'Referidos', adminPanel: 'Panel de admin', academy: 'Academia',
  ...
  en: {
    dashboard: 'Dashboard', accounts: 'MT accounts', manager: 'Guardian', copy: 'Copy', bots: 'Bots', support: 'Support', admin: 'Admin',
    home: 'Home', plans: 'Plans', ambassadors: 'Ambassadors', guide: 'Guide',
    login: 'Sign in', signup: 'Start free',
    myAccount: 'My account', myPlan: 'My plan', referrals: 'Referrals', adminPanel: 'Admin panel', academy: 'Academy',

...
export const NAV_T: Record<Lang, Record<string, string>> = {
  es: {
    dashboard: 'Panel', accounts: 'Cuentas MT', manager: 'Guardian', copy: 'Copy', support: 'Soporte', admin: 'Admin',
  ...
  en: {
    dashboard: 'Dashboard', accounts: 'MT accounts', manager: 'Guardian', copy: 'Copy', support: 'Support', admin: 'Admin',

...
const K = {
  es: {
    ...
    steps: [
      ...
      { t: '5. Marca la casilla y pega los dos campos', d: 'Al soltarlo se abre una ventana. Marca "Permitir Algo Trading" y, en la pestaña de parámetros, pega la dirección del servidor y tu clave. Luego OK.', copy: 'url', viz: 'fields' },
  ...
  en: {
    ...
    steps: [
      ...
      { t: '5. Tick the box and paste the two fields', d: 'A window opens. Tick "Allow Algo Trading" and, in the inputs tab, paste the server URL and your key. Then OK.', copy: 'url', viz: 'fields' },

...
const G: any = {
  es: {
    ...
    symMap: 'Si un broker usa un nombre imposible, en los Inputs de la EA Esclava tienes el campo SymbolMap para escribir tu la equivalencia: US100=NAS100.pro;GOLD=XAUUSD. Esa tabla manda por encima de todo.',
  ...
  en: {
    ...
    symMap: 'If a broker uses an impossible name, the Slave EA has a SymbolMap input where you type the mapping yourself: US100=NAS100.pro;GOLD=XAUUSD. That table overrides everything.',

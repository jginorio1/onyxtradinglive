...
export default function CoachCard() {
  ...
  return (
    <div className="card" style={{ marginBottom: 14, border: '1px solid rgba(124,140,255,.3)' }}>
      <div className="row between" style={{ flexWrap: 'wrap', gap: 8, marginBottom: txt ? 10 : 0 }}>
      ...
      {txt && <div style={{ background: 'var(--bg2)', border: '1px solid var(--line)', borderRadius: 10, padding: '12px 14px', fontSize: 14, lineHeight: 1.65, whiteSpace: 'pre-wrap' }}>{txt}</div>}
    </div>
  );
}

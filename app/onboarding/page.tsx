...
const T = {
  es: {
    ...
    sty: [['scalping', 'Scalping'], ['day', 'Day trading'], ['swing', 'Swing'], ['position', 'Position'], ['algo', 'Trader algorítmico (bots)']],
    plat: [['mt5', 'MetaTrader 5'], ['mt4', 'MetaTrader 4'], ['ctrader', 'cTrader'], ['matchtrader', 'MatchTrader'], ['ambas', 'Varias']],
  ...
  en: {
    ...
    sty: [['scalping', 'Scalping'], ['day', 'Day trading'], ['swing', 'Swing'], ['position', 'Position'], ['algo', 'Algo trader (bots)']],
    plat: [['mt5', 'MetaTrader 5'], ['mt4', 'MetaTrader 4'], ['ctrader', 'cTrader'], ['matchtrader', 'MatchTrader'], ['ambas', 'Several']],

...
export default function Retention() {
  ...
  const OUTCOME: any = {
    saved_discount: [t.out_discount, 'var(--green)'],
    saved_pause: [t.out_pause, 'var(--green)'],
    saved_downgrade: [t.out_downgrade, 'var(--gold)'],
    canceled: [t.out_canceled, 'var(--red)'],
    pending: [t.out_pending, 'var(--mut)'],
  };
            ...
            <div key={c.id} style={{ borderTop: '1px solid var(--line)', padding: '10px 0' }}>
              <div className="row between" style={{ flexWrap: 'wrap', gap: 8 }}>
                ...
                <div className="row" style={{ gap: 8 }}>
                  ...
                  <span className="muted" style={{ fontSize: 12 }}>{fmtDate(c.created_at, lang)}</span>
                </div>
              </div>

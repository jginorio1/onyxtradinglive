...
const _tabOpts = { ssr: false, loading: () => <div className="muted" style={{ padding: '32px 0', textAlign: 'center', fontSize: 13 }}>…</div> };
const Ambassadors = dynamic(() => import('./Ambassadors'), _tabOpts);
const Retention = dynamic(() => import('./Retention'), _tabOpts);
const Emails = dynamic(() => import('./Emails'), _tabOpts);
const Campaigns = dynamic(() => import('./Campaigns'), _tabOpts);
const SeoPanel = dynamic(() => import('./SeoPanel'), _tabOpts);
const TestConsole = dynamic(() => import('./TestConsole'), _tabOpts);
const Firms = dynamic(() => import('./Firms'), _tabOpts);
const CatalogAdmin = dynamic(() => import('./CatalogAdmin'), _tabOpts);
const SupportInbox = dynamic(() => import('./SupportInbox'), _tabOpts);
const Diagnostics = dynamic(() => import('./Diagnostics'), _tabOpts);
const Resources = dynamic(() => import('./Resources'), _tabOpts);
const KbEditor = dynamic(() => import('./KbEditor'), _tabOpts);
const BlogEditor = dynamic(() => import('./BlogEditor'), _tabOpts);
const Backups = dynamic(() => import('./Backups'), _tabOpts);
const Audit = dynamic(() => import('./Audit'), _tabOpts);
const Optimize = dynamic(() => import('./Optimize'), _tabOpts);
const Revenue = dynamic(() => import('./Revenue'), _tabOpts);
const Finanzas = dynamic(() => import('./Finanzas'), _tabOpts);
const AcademyAdmin = dynamic(() => import('./AcademyAdmin'), _tabOpts);
const Facturacion = dynamic(() => import('./Facturacion'), _tabOpts);
const LandingBuilder = dynamic(() => import('./LandingBuilder'), _tabOpts);
const NotifAdmin = dynamic(() => import('./NotifAdmin'), _tabOpts);
const GuideEditor = dynamic(() => import('./GuideEditor'), _tabOpts);
const TeamChat = dynamic(() => import('./TeamChat'), _tabOpts);

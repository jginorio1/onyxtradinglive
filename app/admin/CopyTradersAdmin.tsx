    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      <div className="card" style={glow('var(--green)')}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(min(100%,220px),1fr))', gap: 14 }}>
          <div style={{ background: 'var(--bg2)', borderRadius: 10, padding: 12, minWidth: 0, overflow: 'hidden' }}>
          ...
          <div style={{ background: 'var(--bg2)', borderRadius: 10, padding: 12, minWidth: 0, overflow: 'hidden' }}>
            ...
            <select value={config.followGate || 'all'} onChange={(e) => setConfig({ ...config, followGate: e.target.value })} style={{ width: '100%', maxWidth: '100%', margin: 0, padding: '7px 9px', fontSize: 13, textOverflow: 'ellipsis' }}>
